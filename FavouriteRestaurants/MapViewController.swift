...
class MapViewController: UIViewController, MKMapViewDelegate {
    ...
    var currentPlacemark:CLPlacemark? // it is the placemark object of the selected restaurant
    ...
    override func viewDidLoad() {
        ...
        segmentedControl.addTarget(self, action: #selector(MapViewController.showDirection(_:)), forControlEvents:.ValueChanged)
    ...
    // get called when press in an annotation
